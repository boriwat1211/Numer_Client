...
test("Cramer's Rule Test",async () =>{
  ...
  await waitFor(()=>{expect(screen.queryByText(/Loading/i)).not.toBeInTheDocument()},{timeout:1500})
  await waitFor(()=>{expect(screen.getByText(/CramerRule/i)).toBeInTheDocument()},{timeout:5000})
  const history = createMemoryHistory()
  ...
  await waitFor(()=>{expect(screen.getAllByPlaceholderText("Unit2Result")[0]).toBeInTheDocument()},{timeout:5000})
},60000)
...
test("GaussElimination Test",async () =>{
  ...
  await waitFor(()=>{expect(screen.queryByText(/Loading/i)).not.toBeInTheDocument()},{timeout:1500})
  await waitFor(()=>{expect(screen.getByText(/GaussElimination/i)).toBeInTheDocument()},{timeout:5000})
  const history = createMemoryHistory()
...
test("GaussJordan Test",async () =>{
  ...
  await waitFor(()=>{expect(screen.queryByText(/Loading/i)).not.toBeInTheDocument()},{timeout:1500})
  await waitFor(()=>{expect(screen.getByText(/GaussJordan/i)).toBeInTheDocument()},{timeout:5000})
  const history = createMemoryHistory()
...
test("GaussSeidelIteration Test",async () =>{
  ...
  await waitFor(()=>{expect(screen.queryByText(/Loading/i)).not.toBeInTheDocument()},{timeout:1500})
  await waitFor(()=>{expect(screen.getByText(/GaussSeidelIteration/i)).toBeInTheDocument()},{timeout:5000})
  const history = createMemoryHistory()
...
test("JacobiIteration Test",async () =>{
  ...
  await waitFor(()=>{expect(screen.queryByText(/Loading/i)).not.toBeInTheDocument()},{timeout:1500})
  await waitFor(()=>{expect(screen.getByText(/JacobiIteration/i)).toBeInTheDocument()},{timeout:5000})
  const history = createMemoryHistory()
...
test("Conjugategradient test",async () =>{
  ...
  await waitFor(()=>{expect(screen.queryByText(/Loading/i)).not.toBeInTheDocument()},{timeout:1500})
  await waitFor(()=>{expect(screen.getByText(/Conjugategradient/i)).toBeInTheDocument()},{timeout:5000})
  const history = createMemoryHistory()
...
test("LUdecomposition test",async () =>{
  ...
  await waitFor(()=>{expect(screen.queryByText(/Loading/i)).not.toBeInTheDocument()},{timeout:1500})
  await waitFor(()=>{expect(screen.getByText(/LUdecomposition/i)).toBeInTheDocument()},{timeout:5000})
  const history = createMemoryHistory()
...
test("NewtonDividedDifference test",async () =>{
  ...
  await waitFor(()=>{expect(screen.queryByText(/Loading/i)).not.toBeInTheDocument()},{timeout:1500})
  await waitFor(()=>{expect(screen.getByText(/NewtonDividedDifference/i)).toBeInTheDocument()},{timeout:5000})
  const history = createMemoryHistory()
  ...
  //case1
  await waitFor(()=>{expect(screen.getByText("Result : 9.686255")).toBeInTheDocument()},{timeout:5000})
  //case2 
...
test("LagrangeInterpolation test",async () =>{
  ...
  await waitFor(()=>{expect(screen.queryByText(/Loading/i)).not.toBeInTheDocument()},{timeout:1500})
  await waitFor(()=>{expect(screen.getByText(/LagrangeInterpolation/i)).toBeInTheDocument()},{timeout:5000})
  const history = createMemoryHistory()
  ...
  //case1
  await waitFor(()=>{expect(screen.getByText("Result : 220.796875")).toBeInTheDocument()},{timeout:5000})
  //case2
  ...
  fireEvent.change(screen.getByTestId("Unit3-Select-Question") as HTMLInputElement,{target: {value: "[2,3,4]"}});
  await waitFor(()=>{expect((screen.getByTestId("Unit3-Select-Question") as HTMLInputElement).value).toEqual("[2,3,4]")},{timeout:5000})
  await waitFor(()=>{expect(screen.getByText("Result : -0.315260")).toBeInTheDocument()},{timeout:5000})
...
test("LinearRegression test",async () =>{
  ...
  await waitFor(()=>{expect(screen.queryByText(/Loading/i)).not.toBeInTheDocument()},{timeout:1500})
  await waitFor(()=>{expect(screen.getByText("LinearRegression")).toBeInTheDocument()},{timeout:5000})
  const history = createMemoryHistory()
  ...
  await waitFor(()=>{expect(screen.getByText("Result : 36.240000")).toBeInTheDocument()},{timeout:5000})
},60000)
...
test("PolynomialRegression test",async () =>{
  ...
  await waitFor(()=>{expect(screen.queryByText(/Loading/i)).not.toBeInTheDocument()},{timeout:1500})
  await waitFor(()=>{expect(screen.getByText(/PolynomialRegression/i)).toBeInTheDocument()},{timeout:5000})
  const history = createMemoryHistory()
  ...
  await waitFor(()=>{expect(screen.getByText("Result : 0.674706")).toBeInTheDocument()},{timeout:5000})
},60000)
...
test("MultipleLinearRegression test",async () =>{
  ...
  await waitFor(()=>{expect(screen.queryByText(/Loading/i)).not.toBeInTheDocument()},{timeout:1500})
  await waitFor(()=>{expect(screen.getByText(/MultipleLinearRegression/i)).toBeInTheDocument()},{timeout:5000})
  const history = createMemoryHistory()
  ...
  await waitFor(()=>{expect(screen.getByText("Result : -9.000000")).toBeInTheDocument()},{timeout:5000})
},60000)
...
test("Trapzoidal test",async () =>{
  ...
  await waitFor(()=>{expect(screen.queryByText(/Loading/i)).not.toBeInTheDocument()},{timeout:1500})
  await waitFor(()=>{expect(screen.getByText(/Trapzoidal/i)).toBeInTheDocument()},{timeout:5000})
  const history = createMemoryHistory()
  ...
  await waitFor(()=>{expect(screen.getByText("Result : 357984.000000")).toBeInTheDocument()},{timeout:5000})
},60000)
...
test("Simpson test",async () =>{
  ...
  await waitFor(()=>{expect(screen.queryByText(/Loading/i)).not.toBeInTheDocument()},{timeout:1500})
  await waitFor(()=>{expect(screen.getByText(/Simpson/i)).toBeInTheDocument()},{timeout:5000})
  const history = createMemoryHistory()
  ...
  await waitFor(()=>{expect(screen.getByText("Result : 68.015625")).toBeInTheDocument()},{timeout:5000})
},60000)
...
test("DividedDifference test",async () =>{
  ...
  await waitFor(()=>{expect(screen.queryByText(/Loading/i)).not.toBeInTheDocument()},{timeout:1500})
  await waitFor(()=>{expect(screen.getByText("DividedDifference")).toBeInTheDocument()},{timeout:5000})
  const history = createMemoryHistory()
  ...
  await waitFor(()=>{expect(screen.getByText("Result : 8.394719")).toBeInTheDocument()},{timeout:5000})
},60000)